...
export default function MobileBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-warm-white/98 backdrop-blur-md border-t border-pink/30 pb-safe">
          ...
          return (
            <Link
              ...
              className={`flex-1 flex flex-col items-center justify-center py-3 gap-1 transition-colors relative ${
                isActive ? "text-brand" : "text-medium-gray"
              }`}
            >
              {item.icon(isActive)}
              ...
              {isActive && (
                <motion.div
                  ...
                  className="absolute bottom-0 w-8 h-0.5 bg-brand rounded-full"
                />
              )}
            </Link>
          );
